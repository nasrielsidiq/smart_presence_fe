        ...
        <div className="bg-white p-6 rounded-lg shadow-lg mt-16">
            <div className="flex justify-between items-center mb-4 mt-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        <input type="text" placeholder="Search" className="border border-black/60 px-4 py-2 rounded-2xl shadow-md text-xs" />
                        <span className="absolute right-3 top-1 text-gray-500">
                            <i className="bi bi-search text-xs"></i>
                        </span>
                    </div>
                    
                    <button className="bg-brightGold text-white text-xs font-bold px-4 py-1 rounded-xl shadow-md flex items-center gap-2">
                ...
                <table className="w-full border-collapse overflow-hidden border-black/30">
                    ...
                    <tbody>
                        <tr className="border-t border-black/30">
                            ...
                            <td className="px-4 py-2 text-center">Bandung</td>
                            <td className="px-4 py-2 text-center">012345678</td>
                            <td className="px-4 py-2 text-center">
                                <button className="bg-skyBlue text-white px-6 py-[4px] rounded-xl ">Edit
                                    <i className="bi bi-pencil-fill"></i>
                                </button>
                                <button className="bg-brightGold text-white px-6 py-[4px] rounded-xl ">Delete    
