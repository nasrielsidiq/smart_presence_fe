...
const ModalCreate = ({ closeModal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(ENDPOINTS.DEVICE, {
                method: 'POST',
                headers: {
            ...
            <div id="background" className="p-8 rounded-lg bg-white/30 border-2 border-white w-2/3">
                <form className="bg-white rounded-lg shadow-lg " onSubmit={handleSubmit}>
                    <div className="px-6 py-3 flex justify-between bg-white items-center shadow-md">
                        <h3 className="text-lg font-bold text-blue pt-2">Create Device</h3>
                        ...
                        <div className="mt-2">
                            <div className="grid grid-cols-2 gap-4 mt-4">
                                <div className="mx-5">
                                    ...
                                    <input type="text" name="device_code" className="border-2 border-dodgerBlue rounded-lg hover:bg-blue-100 text-dodgerBlue mt-2 px-4 py-2 w-full" value={formData.name} onChange={handleChange} />
                                </div>
                                <div className="mx-5">
                                    <label className="block text-gray-700 font-medium">Device Name</label>
                                    <input type="text" name="device_name" className="border-2 border-dodgerBlue rounded-lg hover:bg-blue-100 text-dodgerBlue mt-2 px-4 py-2 w-full" value={formData.name} onChange={handleChange} />
                                </div>
                                <div className="mx-5">
                                ...
                                <div className="mx-5">
                                    ...
                                    <input type="text" name="location" className="border-2 border-dodgerBlue rounded-lg hover:bg-blue-100 text-dodgerBlue mt-2 px-4 py-2 w-full" value={formData.name} onChange={handleChange} />
                                </div>
                            </div>
                        </div>
                    </div>
